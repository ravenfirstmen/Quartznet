...
namespace Quartz.AspNetCore.Server.Dtos
{
    public class TriggerDetailDto
    {
        ...
        public static TriggerDetailDto Create(ITrigger trigger, ICalendar calendar)
        {
            ...
            if (simpleTrigger != null) return new SimpleTriggerDetailDto(simpleTrigger, calendar);
            var cronTrigger = trigger as ICronTrigger;
            if (cronTrigger != null) return new CronTriggerDetailDto(cronTrigger, calendar);
            var calendarIntervalTrigger = trigger as ICalendarIntervalTrigger;
            if (calendarIntervalTrigger != null) return new CalendarIntervalTriggerDetailDto(calendarIntervalTrigger, calendar);
            var dailyTimeIntervalTrigger = trigger as IDailyTimeIntervalTrigger;
            if (dailyTimeIntervalTrigger != null) return new DailyTimeIntervalTriggerDetailDto(dailyTimeIntervalTrigger, calendar);
